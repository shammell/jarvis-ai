...
- [[.can_handle()_8]] - `method` [EXTRACTED]
- [[.execute()_11]] - `method` [EXTRACTED]
- [[Agent that verifies results]] - `rationale_for` [EXTRACTED]
...
- [[SwarmAgent_2]] - `inherits` [EXTRACTED]
- [[swarm_coordinator.py]] - `contains` [EXTRACTED]
